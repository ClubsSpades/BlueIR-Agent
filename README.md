...
当前版本定位为比赛 MVP：通过 DeepSeek API、结构化安全 Skill、只读分析工具和轻量 Web UI，实现告警分诊、IOC 提取、时间线整理、Webshell 日志分析、Windows 登录爆破分析、Linux 应急证据分析、MITRE ATT&CK 映射和 Markdown 应急报告生成。
